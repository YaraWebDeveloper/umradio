...
<div class="page-header">
    <h1>Roles de Usuario <small>Administración</small></h1>
</div>
...
<div id="myTabContent" class="tab-content">
        ...
        <div class="tab-pane fade in active" id="uno">
            <?php if ($Registros != ' ') { ?>
                ...
                <table class="table table-condensed table-striped">
                    ...
                    <tbody>
                        <?php
                        foreach ($Registros as $itemUsuarioRol):
                            echo ' 
                                <tr>              
                                    <td> ' . $itemUsuarioRol->usu_rol_nombre . ' </td>
                                    <td> ' . reemplazarEstado($itemUsuarioRol->est_id) . ' </td>
                                    <td> <a href="' . base_url($this->uri->segment(1) . "/editarUsuarioRol/" . $itemUsuarioRol->usu_rol_id) . '">Editar</a> </td>
                                </tr>
                                ';
    ...
    ?>" id="dos">
         <?php
         $dataInput = controlInput('usu_rol_nombre', $valorNombre, 'Usuario Rol', 'required');
         $dataEstados = controlSelect();
         $dataSelected = array($valorEstado);
         ?>
        <!-- inicio formulario -->
        <h2>Administrar Usuario Rol</h2>
        <?php
        $dataAtributos = array(
            'class' => 'formulario'
        );
        ...
        <table class="table table-condensed table-striped">
            <tr>
                <td class="align-right"><?php echo form_label('Usuario Rol', 'lab_usu_rol_nombre'); ?></td>
